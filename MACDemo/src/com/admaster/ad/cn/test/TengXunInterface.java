...
//^[\u4E00-\u9FA5]+$
    ...
    public static void main(String[] args) {
        try {
            TengXunInterface cm=new TengXunInterface();
            HashSet<String> hashSet = new HashSet<String>();
            cm.SaveHashFile("/Users/ZhangQian/Desktop/blacklist/black.txt", hashSet);
            TengXunInterface cm1=new TengXunInterface();
            TengXunInterface cm2=new TengXunInterface();
            TengXunInterface cm3=new TengXunInterface();
            TengXunInterface cm4=new TengXunInterface();
            TengXunInterface cm5=new TengXunInterface();
            TengXunInterface cm6=new TengXunInterface();
            TengXunInterface cm7=new TengXunInterface();
            TengXunInterface cm8=new TengXunInterface();
            TengXunInterface cm9=new TengXunInterface();
////            
//            Main cm10=new Main();
//            Main cm11=new Main();
//            Main cm12=new Main();
...
//            cm.Download(imgSrc);
    ...
    public static void startTask(TengXunInterface main,String filePath,HashSet<String> hashSet){
    ...
    public static String gene(String s,int level,TengXunInterface cm,HashSet<String> hashTest,String filePath){
        if(level == 5){
//            result.add(s);
        	//得到电话号码，去数据库中查询
//        	decrypt.a(s);
        	 String HTML;
			try {
				synchronized (TengXunInterface.class) {
					count ++;
				}
//				Thread.sleep(5000);
    ...
    public void ReadFile(String filePath,TengXunInterface cm,HashSet<String> hashSet){
//		System.out.println("http://gujia.jihaoba.cohtm");
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
            	...
            	HTML = cm.getJsonHtml("https://txwz.qq.com/lib/index.php?m=check&a=run&issms=1&keys=" + str +"&_=1535440393632&callback=Zepto1535440372329",str,filePath);
